...
* The Magnets are brittle. A rapid shock with another magnet or ferromagnetic material may release shards dangerous for the eyes.

* The apparatus **MUST NOT** be used by people with pacemakers.

**always ground the equipment: while there is no safety risk, ground is required for correct operation**
...
# Authorship
This Handbook was originally written by Giacomo Torzo from Padua University.

Rewritten and integrated by Davide Bortolami and Statistical analysis by Simone Tosato of [Fermium LABS](http://fermiumlabs.com)
...
```{r QRCODE, out.width='50%',echo=FALSE,fig.align = 'center'}
knitr::include_graphics('Assets/Figures/qr_last.png')
```
