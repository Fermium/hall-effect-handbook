...
![Measured $B$ values vs gap width $d$](Media/H_vs_d.jpeg){#fig:BvsGapD  height=40%}
\ 

An example of the measured $V_H$ vs. magnetic field $B$ at room temperature is shown in figure {@fig:HallvsIb}.


![Hall voltage versus magnetic field intensity $B$  .](Media/Vh_vs_B.jpeg){#fig:HallvsIb  height=40%}
\ 
...
![Output voltages versus time.](Media/Out_vs_time.jpg){#fig:Output_voltages_versus_time  height=40%}
\ 
...
![Example of calculated data ](Media/example.png){#fig:Example  height=40%}
\ 
...
![Example of linear best fit in the intrinsic region (high temperature) ](Media/ImageEgFit.jpg){#fig:EgFit  height=40%}
\ 
