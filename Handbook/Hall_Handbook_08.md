...
![The thermocouple sensitivity (the Seebeck coefficient) does strongly depend on temperature.](Assets/Figures/seebeck_coefficient_vs_temperature.png){#fig:seebeckNonlinearity  width=30%}
