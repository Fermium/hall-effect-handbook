...
In order to get a correct measurement it is necessary to compensate for the non-linearity (see figure [fix]) of the thermocouple linearly extrapolating the following polynomial:w
...
* *New Semiconductor materials. Characteristics and Properties*, http://www.ioffe.rssi.ru/SVA/NSm/introduction.html (Electronic archive)
