...
![simplified schematic of the sample circuitry](Media/sample_circuitry.png){#fig:sample_circuitry  height=40%}
\ 
...
![Printed circuit board with germanium sample and thermocuple](Media/sample_pcb.jpg){#fig:sample_pcb  height=40%}
\ 
...
![Device front panel](Media/imageFrontPanel0.jpg){#fig:frontPanel  height=40%}
\ 
