...
install_r_packages:
	@Rscript -e "install.packages('rmarkdown',repos='https://cran.rstudio.com');install.packages('bookdown',repos='https://cran.rstudio.com');install.packages('here',repos='https://cran.rstudio.com');install.packages('tidyverse',repos='https://cran.rstudio.com');install.packages('gridExtra',repos='https://cran.rstudio.com');"
